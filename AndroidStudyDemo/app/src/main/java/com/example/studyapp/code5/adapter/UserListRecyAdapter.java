package com.example.studyapp.code5.adapter;
 ...
 */
public class UserListRecyAdapter extends RecyclerView.Adapter {
    private List<UserBean> mPhoneBeanList;
    private Context mContext;

    public UserListRecyAdapter(List<UserBean> phoneBeanList, Context context) {
...
//        View inflate = View.inflate(mContext, R.layout.activity_list1_item, null);
         ...
         */
        View inflate = layoutInflater.inflate(R.layout.activity_list3_item, parent,false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        //取出数据
        UserBean phoneBean = mPhoneBeanList.get(position);
    ...
    private static class CustomHolder extends RecyclerView.ViewHolder {
         ...
         * @param position
         */
        public void setData(UserBean phoneBean, int position) {
            userNameTextView.setText(phoneBean.getUserName() + " ID " + phoneBean.getId());
